...
public class CommonConfig {
  ...
  private double pipeDataStructureWalMemoryProportion = 0.6;
  ...
  private double pipeWALCacheInsertNodeMemoryProportion = 0.2;
  private double pipeWAlCacheBufferMemoryProportion = 0.8;
